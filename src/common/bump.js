...
class Bump {
  ...
  */
  ...
  hitTestPoint(point, sprite) {
    ...
    let shape; let left; let right; let top; let bottom; let vx; let vy; let magnitude; let
      hit;
  ...
  */
  ...
  hitTestCircle(c1, c2, global = false) {
    ...
    let vx; let vy; let magnitude; let combinedRadii; let
      hit;
  ...
  */
  ...
  rectangleCollision(r1, r2, bounce = false, global = true) {
    ...
    let collision; let combinedHalfWidths; let combinedHalfHeights; let overlapX; let overlapY; let vx; let
      vy;
  ...
  */
  ...
  hitTestCircleRectangle(c1, r1, global = false) {
    ...
    else if (c1x - c1.xAnchorOffset < r1x - Math.abs(r1.halfWidth) - r1.xAnchorOffset) {
      region = 'leftMiddle';
    } else {
      region = 'rightMiddle';
    }
  ...
  */
  ...
  hit(a, b, react = false, bounce = false, global, extra = undefined) {
    ...
    function findCollisionType(a, b) {
      ...
      if (bIsASprite && !(a.x === undefined) && !(a.y === undefined)) {
